...
* Installation via les dépendances de homebridge-config-ui-x + bouton pour y accéder. 
...
(installation/désinstallation/mettre à jour plugin + redémarrer homebridge + visualiser les accessoires fonctionnent (pratique pour ceux qui utilisent homebridge-alexa ou homebridge-gsh et qui n'ont pas de iDevice) !)
