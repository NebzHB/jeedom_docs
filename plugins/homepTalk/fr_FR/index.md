...
-	**norestart** sans autre valeur, sans égal, juste le paramètre, permet de ne pas relancer la musique (si elle devait se relancer, donc s'il y en avait une qui jouait avant, si c'est pas un groupe et si le homepod est pas en multi-room)
...
>C'est normal, mais vous pouvez utiliser la nouvelle fonctionnalité jingle pour jouer un son avant une annonce Parle.
6. Pourquoi ça va plus vite le deuxième fois que je fais prononcer la même phrase ?
...
7. Pour le système de TTS OSX, dois-je laisser tout le temps mon mac allumé ?
...
8. J'ai envie de voix plus fun ou mieux faites
...
9. Les mêmes phrases toujours prononcées c'est un peu monotone.
